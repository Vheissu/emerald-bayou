...
// ---- props ----
export function cooler(rr) { const g = new THREE.Group(); const b = new THREE.Mesh(new THREE.BoxGeometry(0.58, 0.4, 0.38), rr() < 0.5 ? PLASTIC : BLUE); b.position.y = 0.2; g.add(sh(b)); const lid = new THREE.Mesh(new THREE.BoxGeometry(0.6, 0.06, 0.4), PLASTIC); lid.position.y = 0.43; g.add(lid); return g; }
