...
const PLANS = Object.freeze({
  ...
  balanced: Object.freeze({ id: 'balanced', effectBudget: EFFECT_BUDGETS.balanced, warmShaders: false, blockingModels: Object.freeze([]), disabledModels: NO_DISABLED_MODELS, solidGrass: 'deferred', deferOptionalModels: true, modelConcurrency: 2, modelReleaseDelayMs: 700, modelBatchDelayMs: 180, modelIdleTimeoutMs: 1200, terrainReadiness: 'local', minWaitMs: 500, maxWaitMs: 6000, compileDelayMs: 0 }),
  cinematic: Object.freeze({ id: 'cinematic', effectBudget: EFFECT_BUDGETS.cinematic, warmShaders: true, blockingModels: FULL_WARM_MODELS, disabledModels: NO_DISABLED_MODELS, solidGrass: 'blocking', deferOptionalModels: false, modelConcurrency: 4, modelReleaseDelayMs: 0, modelBatchDelayMs: 0, modelIdleTimeoutMs: 900, terrainReadiness: 'settled', minWaitMs: 800, maxWaitMs: 20000, compileDelayMs: 250 }),
});
