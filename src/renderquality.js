...
export const QUALITY_PROFILES = Object.freeze([
  Object.freeze({
    ...
    reflectionMipmaps: false, wakeResolution: 192, wakeMaxStamps: 10, minimapTileLimit: 160, surfaceMist: 0, heatHaze: 0, cloudShadows: 0, precipitationRipples: 0, lensWater: 0, fireflyPoints: 0, spotlightVolume: 0, skyWeatherDetail: 0, bloom: false, finalPass: false,
  }),
  Object.freeze({
    ...
    reflectionMipmaps: false, wakeResolution: 256, wakeMaxStamps: 14, minimapTileLimit: 192, surfaceMist: 0, heatHaze: 0, cloudShadows: 0, precipitationRipples: 0, lensWater: 0, fireflyPoints: 72, spotlightVolume: 0.42, skyWeatherDetail: 0.45, bloom: false, finalPass: false,
  }),
  Object.freeze({
    ...
    reflectionMipmaps: false, wakeResolution: 384, wakeMaxStamps: 18, minimapTileLimit: 224, surfaceMist: 0.65, heatHaze: 0.58, cloudShadows: 0.58, precipitationRipples: 0.62, lensWater: 0.62, fireflyPoints: 153, spotlightVolume: 0.75, skyWeatherDetail: 0.75, bloom: true, finalPass: false,
  }),
  Object.freeze({
    ...
    reflectionMipmaps: true, wakeResolution: 512, wakeMaxStamps: 20, minimapTileLimit: 256, surfaceMist: 1, heatHaze: 1, cloudShadows: 1, precipitationRipples: 1, lensWater: 1, fireflyPoints: 243, spotlightVolume: 1, skyWeatherDetail: 1, bloom: true, finalPass: true,
  }),
]);
